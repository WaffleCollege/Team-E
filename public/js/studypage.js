...
//コメント欄
const cmnt = document.getElementById('exampleInputtext1');
const sent = document.getElementById('sharebtn');
const tl = document.getElementById('timeline');

sent.onclick = function sentcmnt() {
    let ct = cmnt.value;
    console.log(ct);
    ...
    switch (ms) {
        ...
        const a = document.getElementById('cmnt + n');
